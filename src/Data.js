const data = [
  ...
  },
  {
    ...
    quote: "Failure is just another kind of success. The wrong kind.",
    count: 0,
    connections: [],
    faction: "radiant",
  },
  ...
  },
  {
    ...
    quote: "They who live by the wand shall die by my blade.",
    count: 1,
  ...
  },
  {
    ...
    primary_attribute: "Strength",
    page_id: "445",
    lore: "Karroch was born a child of the stocks. His mother died in childbirth; his father, a farrier for the Last King of Slom, was trampled to death when Karroch was five. Afterward Karroch was indentured to the king’s menagerie, where he grew up among all the beasts of the royal court: lions, apes, fell-deer, and things less known, things barely believed in. When the lad was seven, an explorer brought in a beast like none before seen. Dragged before the King in chains, the beast spoke, though its mouth moved not. Its words: a plea for freedom. The King only laughed and ordered the beast perform for his amusement; and when it refused, struck it with the Mad Scepter and ordered it dragged to the stocks.&lt;br&gt;&lt;br&gt;Over the coming months, the boy Karroch sneaked food and medicinal draughts to the wounded creature, but only managed to slow its deterioration. Wordlessly, the beast spoke to the boy, and over time their bond strengthened until the boy found he could hold up his end of a conversation—could in fact speak now to all the creatures of the King's menagerie. On the night the beast died, a rage came over the boy. He incited the animals of the court to rebel and threw open their cages to set them amok on the palace grounds. The Last King was mauled in the mayhem. In the chaos, one regal stag bowed to the boy who had freed him; and with Beastmaster astride him, leapt the high walls of the estate, and escaped. Now a man, Karroch the Beastmaster has not lost his ability to converse with wild creatures. He has grown into a warrior at one with nature’s savagery.",
  ...
  },
  {
    ...
    count: 3,
    connections: ["Earth Spirit", "Storm Spirit", "Ember Spirit"],
    faction: "radiant",
  },
  {
    title: "Bristleback",
  ...
  },
  {
    ...
    count: 4,
    connections: ["Enigma", "Keeper of the Light", "Elder Titan", "Io"],
    faction: "dire",
  },
  {
    title: "Chen",
  ...
  },
  {
    ...
    quote: "By stormcraft, I shall lay my enemies low.",
    count: 1,
    connections: ["Pangolier"],
    faction: "radiant",
  },
  {
    title: "Doom",
    ...
    count: 2,
    connections: ["Shadow Demon", "Shadow Fiend"],
    faction: "dire",
  },
  {
    title: "Dragon Knight",
  ...
  },
  {
    ...
    count: 3,
    connections: ["Pudge", "Windranger", "Slark"],
    faction: "radiant",
  },
  {
    title: "Earth Spirit",
    ...
    count: 3,
    connections: ["Storm Spirit", "Ember Spirit", "Brewmaster"],
    faction: "radiant",
  },
  {
    title: "Earthshaker",
  ...
  },
  {
    ...
    quote: "Balance in all things.",
    count: 4,
    connections: ["Brewmaster", "Earth Spirit", "Storm Spirit", "Juggernaut"],
    faction: "radiant",
  },
  {
    title: "Enchantress",
    ...
    count: 3,
    connections: ["Ursa", "Pangolier", "Terrorblade"],
    faction: "radiant",
  },
  {
    title: "Enigma",
  ...
  },
  {
    ...
    count: 2,
    connections: ["Dark Seer", "Dark Willow"],
    faction: "dire",
  },
  {
    title: "Gyrocopter",
    ...
    quote: "So much for being retired…",
    count: 0,
    connections: [],
    faction: "radiant",
  },
  {
    ...
    count: 2,
    connections: ["Dazzle", "Bloodseeker"],
    faction: "radiant",
  },
  {
    title: "Invoker",
  ...
  },
  {
    ...
    count: 4,
    connections: ["Phantom Lancer", "Templar Assassin", "Sven", "Ember Spirit"],
    faction: "radiant",
  },
  {
    ...
    count: 5,
    connections: ["Enigma", "Elder Titan", "Chaos Knight", "Io", "Phoenix"],
    faction: "radiant",
  },
  {
    title: "Kunkka",
    ...
    count: 2,
    connections: ["Tidehunter", "Dark Willow"],
    faction: "radiant",
  },
  {
  ...
  },
  {
    ...
    quote: "And so the dead will bury the dead.",
    count: 0,
    connections: [],
    faction: "dire",
  },
  ...
  },
  {
    ...
    count: 2,
    connections: ["Pangolier", "Crystal Maiden"],
    faction: "radiant",
  },
  {
    title: "Lion",
    ...
    quote: "All hell's broken loose, and I hold the pieces.",
    count: 2,
    connections: ["Nyx Assassin", "Pangolier"],
    faction: "dire",
  },
  {
    title: "Lone Druid",
  ...
  },
  {
    ...
    count: 3,
    connections: ["Rubick", "Bounty Hunter", "Dark Willow"],
    faction: "dire",
  },
  {
    title: "Mirana",
  ...
  },
  {
    ...
    quote: "Behold the Pope of Pestilence.",
    count: 1,
    connections: ["Pangolier"],
    faction: "dire",
  },
  ...
  },
  {
    ...
    count: 3,
    connections: ["Abaddon", "Lion", "Broodmother"],
    faction: "dire",
  },
  {
    title: "Ogre Magi",
  ...
  },
  {
    ...
    primary_attribute: "Agility",
    page_id: "333795",
    lore: "The men and women that make up the Nivan Gallants live a life of swordplay, chandelier swinging, and tawdry romance. And while all adhere to their creed that &quot;A life of adventure is the only life worth living,&quot; the exploits of Donté Panlin still manage to raise the eyebrows of even the most hedonistic of swordsmen.&lt;br&gt;&lt;br&gt;There is no monster he won’t slay. No creature he won’t woo. No tyrant he won’t stand against. And no noble immune to his silver tongue.",
    quote: "The honorable Donté Panlin, at your service.",
    count: 9,
    connections: [
      "Bristleback",
      "Lion",
  ...
  },
  {
    ...
    count: 2,
    connections: ["Dark Willow", "Juggernaut"],
    faction: "radiant",
  },
  {
    title: "Phoenix",
    ...
    quote: "Chirp!",
    count: 1,
    connections: ["Keeper of the Light"],
    faction: "radiant",
  },
  {
    title: "Puck",
    ...
    count: 3,
    connections: ["Vengeful Spirit", "Io", "Dark Willow"],
    faction: "radiant",
  },
  {
    title: "Pudge",
  ...
  },
  {
    ...
    count: 3,
    connections: ["Pudge", "Meepo", "Dark Willow"],
    faction: "radiant",
  },
  {
    title: "Sand King",
  ...
  },
  {
    ...
    count: 2,
    connections: ["Naga Siren", "Dark Willow"],
    faction: "radiant",
  },
  {
    title: "Silencer",
    ...
    quote: "Enemies should be seen and not heard.",
    count: 1,
    connections: ["Anti-Mage"],
    faction: "radiant",
  },
  {
    title: "Skywrath Mage",
    ...
    count: 2,
    connections: ["Vengeful Spirit", "Terrorblade"],
    faction: "radiant",
  },
  {
    title: "Slardar",
  ...
  },
  {
    ...
    count: 3,
    connections: ["Pudge", "Naga Siren", "Drow Ranger"],
    faction: "dire",
  },
  {
    title: "Sniper",
    ...
    quote: "Now that's what I call stopping power.",
    count: 0,
    connections: [],
    faction: "radiant",
  },
  {
    ...
    quote: "Among the Transcendencies, you would be thought ignoble.",
    count: 2,
    connections: ["Puck", "Dark Willow"],
    faction: "dire",
  },
  {
    ...
    quote: "I'm the beast of many parts; I part enemies from their lives.",
    count: 0,
    connections: [],
    faction: "dire",
  },
  {
    ...
    count: 4,
    connections: ["Razor", "Earth Spirit", "Ember Spirit", "Brewmaster"],
    faction: "radiant",
  },
  {
    title: "Sven",
    ...
    count: 2,
    connections: ["Crystal Maiden", "Juggernaut"],
    faction: "radiant",
  },
  {
    title: "Techies",
    ...
    quote: `Measurements made. Bombs built. Powder's dry. Okay, let's blow something up!`,
    count: 0,
    connections: [],
    faction: "radiant",
  },
  ...
  },
  {
    ...
    count: 3,
    connections: ["Warlock", "Skywrath Mage", "Enchantress"],
    faction: "dire",
  },
  {
    title: "Tidehunter",
    ...
    count: 2,
    connections: ["Kunkka", "Dark Willow"],
    faction: "dire",
  },
  {
    title: "Timbersaw",
  ...
  },
  {
    ...
    quote: "Victory is 10% inspiration, 90% decapitation!",
    count: 0,
    connections: [],
    faction: "radiant",
  },
  ...
  },
  {
    ...
    quote: "I suffer the innocents and guilty alike. There are no innocents.",
    count: 1,
    connections: ["Shadow Shaman"],
    faction: "radiant",
  },
  {
    ...
    quote: `After a bar brawl it's customary, as a courtesy, to buy everyone who's still standing a round of drinks.`,
    count: 2,
    connections: ["Bristleback", "Crystal Maiden"],
    faction: "radiant",
  },
  {
    title: "Underlord",
  ...
  },
  {
    ...
    quote: "Where go the living, the dead soon follow.",
    count: 1,
    connections: ["Dark Willow"],
    faction: "dire",
  },
  {
    ...
    count: 2,
    connections: ["Pangolier", "Enchantress"],
    faction: "radiant",
  },
  {
  ...
  },
  {
    ...
    quote: "You've failed the acid test.",
    count: 1,
    connections: ["Pugna"],
    faction: "dire",
  },
  ...
  },
  {
    ...
    quote: "Malpractice makes perfect.",
    count: 0,
    connections: [],
    faction: "dire",
  },
